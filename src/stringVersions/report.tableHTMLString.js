...
<div id="report-preview-content">
  ...
  <table
    style="border: 1px solid black; padding: 0px; width: auto;"
    cellspacing="0"
  >
    <!-- Table header -->
    <tr>
    ...
    <template v-for="line in table.table">
      ...
      >
        ...
        <td
          v-if="line.heading=='true' || line.execution_var_no=='true'"
          v-bind:class="getClassNameWideCell(line)"
          colspan="2"
          cellspacing="0"
        >
          {{line.name}}
        ...
        <td
          v-if="line.heading!='true' && line.execution_var_no!='true'"
          v-bind:class="getClassNameNormalCell(line)"
          cellspacing="0"
        >
          {{line.name}}
        </td>
        ...
        <td v-if="line.is_double_line!='true'" class="cellNote" cellspacing="0">
          {{line.note}}
        </td>
        <td
